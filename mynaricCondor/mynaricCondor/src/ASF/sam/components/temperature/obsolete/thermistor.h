...
typedef struct
{
   ...
   // uint16_t usInputVoltagemV;      /**< Voltage input in mV */
...
* @return     Success or library error message
**/
eMpbError_t eThermistorAnalogReadmV( handle_t xStream, uint16_t *pusVoltage , uint16_t *usRaw);
